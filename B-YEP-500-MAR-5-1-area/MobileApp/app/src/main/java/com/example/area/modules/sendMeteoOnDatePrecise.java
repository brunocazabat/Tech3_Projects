...
public class sendMeteoOnDatePrecise extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        return inflater.inflate(R.layout.fragment_send_meteo_on_date_precise, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.send2).setOnClickListener(new View.OnClickListener() {
            final TextView cityTxt = view.findViewById(R.id.city2);
            final TextView yearTxt = view.findViewById(R.id.year);
            final TextView monthTxt = view.findViewById(R.id.month);
            final TextView dayTxt = view.findViewById(R.id.day);
            final TextView hourTxt = view.findViewById(R.id.hour);
            final TextView minuteTxt = view.findViewById(R.id.minutes);
            ...
            public void onClick(View v) {
                ...
                if (j != 0) {
                        ...
                        if (Integer.parseInt(mail[2]) >= Integer.parseInt(month) || x == 1) {
                            ...
                            if (Integer.parseInt(mail[3]) >= Integer.parseInt(day) || x == 1) {
                                if (Integer.parseInt(mail[3]) > Integer.parseInt(day))
                                    x = 1;
                                if (Integer.parseInt(mail[4]) >= Integer.parseInt(hour) + 1 || x == 1) {
                    ...
                    if (good) {
                        ...
                        GetMeteoToMailFromDB(v, mail[0], mail[1], mail[2], mail[3], mail[4], mail[5], savedmail);
                    } else {
    ...
    protected void GetMeteoToMailFromDB(View v, @NonNull String city, @NonNull String year, @NonNull String month, @NonNull String day, @NonNull String hour, @NonNull String minutes, @NonNull String mail) {
        String url = _link.meteoSendDateMail();
        OkHttpClient httpClient = new OkHttpClient.Builder().build();
        MediaType mediaType = MediaType.parse("application/json");
        String sendStr = "{\"actions\": \"METEO\", \"actionParameter\": \"" + mail + "\", \"city\": \"" + city + "\", \"date\": {\"year\": "+ Integer.parseInt(year) + ", \"month\": "+
            ...
            public void onResponse(Call call, Response response) throws IOException {
                if (response.isSuccessful()) {
                    ...
                    try {
                        ...
                        switch (result) {
                            case "true":
                                NavHostFragment.findNavController(sendMeteoOnDatePrecise.this).navigate(R.id.action_sendMeteoOnDatePrecise_to_SecondFragment);
