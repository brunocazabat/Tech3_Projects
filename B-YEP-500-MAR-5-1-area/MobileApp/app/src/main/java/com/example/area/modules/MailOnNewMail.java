...
public class MailOnNewMail extends Fragment{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        return inflater.inflate(R.layout.mail_on_new_mail, container, false);
    }
    ...
    protected void EpitechMessageToDB(View v, @NonNull String mail) {
        String url = _link.MailOnNewMail(mail);
            ...
            public void onResponse(Call call, Response response) throws IOException {
                if (response.isSuccessful()) {
                    ...
                    try {
                        ...
                        switch (result) {
                            case "true":
                                NavHostFragment.findNavController(MailOnNewMail.this).navigate(R.id.action_mailOnNewMail_to_SecondFragment);
