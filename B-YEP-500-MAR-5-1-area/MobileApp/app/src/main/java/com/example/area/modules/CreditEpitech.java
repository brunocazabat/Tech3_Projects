...
import com.example.area.loginFragment;
...
public class CreditEpitech extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        return inflater.inflate(R.layout.creditepitech, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.send).setOnClickListener(new View.OnClickListener() {
            ...
            final TextView mailTxt = view.findViewById(R.id.mail_epitech);
            @Override
            public void onClick(View v) {
                ...
                if (j != 0) {
                    ...
                    GetMailWhenCreditChangeFromDB(v, update, savedmail, mail);
                }
            }
        });
    }
    ...
    protected void GetMailWhenCreditChangeFromDB(View v, @NonNull String update, @NonNull String mail, @NonNull String epimail) {
        String url = _link.Automate();
        OkHttpClient httpClient = new OkHttpClient.Builder().build();
        MediaType mediaType = MediaType.parse("application/json");
        String sendStr = "{\"update\": \""+ update +"\", \"action\": \"MAIL_GPA_CHANGE\", \"target\": \"" + mail + "\", \"query\": [\""+ epimail + "\"]}";
            ...
            public void onResponse(Call call, Response response) throws IOException {
                if (response.isSuccessful()) {
                    ...
                    try {
                        ...
                        switch (result) {
                            case "true":
                                NavHostFragment.findNavController(CreditEpitech.this).navigate(R.id.action_creditEpitech_to_SecondFragment);
