...
public class NewsCategoryFragment extends Fragment{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        return inflater.inflate(R.layout.newscategory, container, false);
    }

    public int goodCategory(@NonNull String category) {
        String comp = category.toLowerCase();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.send).setOnClickListener(new View.OnClickListener() {
            final TextView categoryTxt = view.findViewById(R.id.category);
            ...
            public void onClick(View v) {
                ...
                if (j == 1) {
                    ...
                    Snackbar.make(view, "Please enter one of the option write above", Snackbar.LENGTH_LONG).show();
                    System.out.println("Please enter one of the option write above");
                }
                else {
                    ...
                    NewsCategoryToMail(v, category,savedmail);
                }
            }
        });
    }
    ...
    protected void NewsCategoryToMail(View v, @NonNull String category, @NonNull String mail) {
        String url = _link.newsCategory(category);
            ...
            public void onResponse(Call call, Response response) throws IOException {
                if (response.isSuccessful()) {
                    ...
                    try {
                        ...
                        switch (result) {
                            case "true":
                                NavHostFragment.findNavController(NewsCategoryFragment.this).navigate(R.id.action_newsCategoryFragment_to_SecondFragment);
                        ...
                        e.printStackTrace();
                        Snackbar.make(v, "Maybe try a more commun category", Snackbar.LENGTH_LONG).show();
                    }
                }
            }
        });
