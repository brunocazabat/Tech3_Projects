...
public class MailerFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.send).setOnClickListener(new View.OnClickListener() {
            final TextView yearTxt = view.findViewById(R.id.Year1);
            final TextView monthTxt = view.findViewById(R.id.Month1);
            final TextView dayTxt = view.findViewById(R.id.Day1);
            final TextView hourTxt = view.findViewById(R.id.Hour1);
            final TextView minuteTxt = view.findViewById(R.id.Minutes1);
            ...
            public void onClick(View v) {
                ...
                if (j != 0) {
                        ...
                        if (Integer.parseInt(mail[1]) >= Integer.parseInt(month) || x == 1 ) {
                            ...
                            if (Integer.parseInt(mail[2]) >= Integer.parseInt(day) || x == 1) {
                                if (Integer.parseInt(mail[2]) > Integer.parseInt(day))
                                    x = 1;
                                if (Integer.parseInt(mail[3]) >= Integer.parseInt(hour) || x == 1) {
                    ...
                    if (good) {
                        ...
                        GetNewsToMailFromDB(v, mail[0], mail[1], mail[2], mail[3], mail[4], savedmail);
                    }
                    else {
    ...
    protected void GetNewsToMailFromDB(View v, @NonNull String year, @NonNull String month, @NonNull String day, @NonNull String hour, @NonNull String minutes, @NonNull String mail) {
        String url = _link.meteoSendDateMail();
        OkHttpClient httpClient = new OkHttpClient.Builder().build();
        MediaType mediaType = MediaType.parse("application/json");
        String sendStr = "{\"actions\": \"NEWS\", \"actionParameter\": \"" + mail + "\", \"date\": {\"year\": "+ Integer.parseInt(year) + ", \"month\": "+
            ...
            public void onResponse(Call call, Response response) throws IOException {
                if (response.isSuccessful()) {
                    ...
                    try {
                        ...
                        switch (result) {
                            case "true":
                                NavHostFragment.findNavController(MailerFragment.this).navigate(R.id.action_mailerFragment_to_SecondFragment);
