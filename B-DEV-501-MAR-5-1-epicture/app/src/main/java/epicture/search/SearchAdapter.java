...
public class SearchAdapter extends RecyclerView.Adapter<SearchAdapter.PhotoVH> {
    ...
    public void onBindViewHolder(@NonNull PhotoVH holder, int position) {
        ...
        Picasso.with(mContext).load("https://i.imgur.com/" + photos.get(position).getId() + ".jpg").into(holder.photo);
    ...
    public static class PhotoVH extends RecyclerView.ViewHolder {
        ...
        private final AppCompatTextView views;
        private final AppCompatTextView upvote;
        private final AppCompatTextView downvote;
