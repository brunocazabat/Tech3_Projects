...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String TAG = epicture.MainActivity.class.getSimpleName();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        imgurWebView.loadUrl("https://api.imgur.com/oauth2/authorize?client_id=2482a548e2389d7&response_type=token");
        ...
        imgurWebView.setWebViewClient(new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                if (url.contains("https://imgur.com/")) {
                    splitUrl(url, view);
                    sendAvatarRequest();
                    Intent profile = new Intent(epicture.MainActivity.this, epicture.Routes.class);
    ...
    private void sendAvatarRequest()
    {
        ...
        Request request = new Request.Builder()
                .url("https://api.imgur.com/3/account/"+ epicture.MainActivity.username + "/avatar")
